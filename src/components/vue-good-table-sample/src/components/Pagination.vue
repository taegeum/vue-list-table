...
<div align="center">
 <div class="paginationclass">
    <div class="pagination-controls pull-center">
      <a href="javascript:undefined" class="page-btn"  :class="{ disabled: !firstIsPossible }"
         @click.prevent.stop="firstPage" tabindex="0">
      ...
      <a href="javascript:undefined" class="page-btn"
         :class="{ disabled: !lastIsPossible }" @click.prevent.stop="lastPage" tabindex="0">
        <span>{{lastText}}</span>
        <span class="chevron" v-bind:class="{ 'right': !rtl, 'left': rtl }"></span>
      </a>
    </div>
    ...
    methods: {
      firstPage() {
        ...
        if(this.firstIsPossible){
          this.currentPage = this.currentPage / this.currentPage
        }
        this.pageChanged()
      },
      previousPage() {
      ...
      lastPage() {
        ...
        if (this.lastIsPossible){
           this.currentPage = this.total / this.currentPerPage
        }
        this.pageChanged();
      },
      pageChanged() {
